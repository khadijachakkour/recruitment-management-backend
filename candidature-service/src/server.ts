...
// on utilise "host.docker.internal" car le service candidature n'est pas dans un conteneur , Après la  conteneurisation du candidature-service il faudra definit SERVICE_HOST sur "localhost"
...
const serviceId = `candidature-service-${PORT}`;
...
async function registerService() {
  ...
  console.log("candidature-service registered with Consul");
}
